...
read -r -p "Chave do Usuário: " DB2_USER
read -r -sp "Senha do Usuário: " DB2_PASSWORD; echo

export DB2_USER
export DB2_PASSWORD

echo "Credenciais para acesso ao DBIQ"
read -r -p "Chave Técnica de Homologação: " DBIQ_USER
read -r -sp "Senha do Usuário Homologação: " DBIQ_TOKEN; echo
